...
try:
    target.write_bytes(base64.b64decode(wrapper.read_bytes()))
except Exception as exc:
    sys.stderr.write(f"Не удалось восстановить gradle-wrapper.jar: {exc}\n")
    sys.exit(1)
PY
    else
        echo "Невозможно восстановить gradle-wrapper.jar: утилита base64 или python3 недоступна" >&2
        exit 1
    fi
fi
